                            ...
                            <div class="row">
                                <div class="col-12">                                    
                                    <div class="border p-3">
                                        <span class="h3">Descrição</span><br>
                                        Texto <br><br>
                                        
                                        <span class="h3">Regulamento</span><br>
                                        Texto<br><br>
                                        
                                        <span class="h3">Cronograma</span><br>
                                        Texto <br><br>
                                        
                                        <span class="h3">Premiação</span><br>
                                        Texto 
                                    </div>
                                </div>
                            </div>
